...
{
    /// <summary>CommandHandler for the select command.</summary>
    public class SelectCommandHandler : ServiceCommandHandlerBase
    {
        ...
        {
            if (request != null && !request.Command.Equals("select", StringComparison.InvariantCultureIgnoreCase))
            {
            ...
            if (request != null && dic.ContainsKey(request.Parameters))
            {
